...
public:
  ...
  FIBITMAP* swapRedBlue(const unsigned int& width, const unsigned int& height) const;
...
//////////////////////////////////////////////////
FIBITMAP* ImagePrivate::swapRedBlue(const unsigned int& width, const unsigned int& height) const
{
