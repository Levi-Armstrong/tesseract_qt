...
if (WIN32)
  set(OGRE_PREFIX_GUESSES
    ${ENV_PROGRAMFILES}/OGRE${OGRE_PATH_SUFFIX}
    C:/OgreSDK
  )
elseif (UNIX)
  set(OGRE_PREFIX_GUESSES
    /opt/ogre${OGRE_PATH_SUFFIX}
    /opt/OGRE${OGRE_PATH_SUFFIX}
    /usr/lib${LIB_SUFFIX}/ogre${OGRE_PATH_SUFFIX}
    /usr/lib${LIB_SUFFIX}/OGRE${OGRE_PATH_SUFFIX}
    /usr/local/lib${LIB_SUFFIX}/ogre${OGRE_PATH_SUFFIX}
    /usr/local/lib${LIB_SUFFIX}/OGRE${OGRE_PATH_SUFFIX}
    /usr/lib/x86_64-linux-gnu/ogre${OGRE_PATH_SUFFIX}
    /usr/lib/x86_64-linux-gnu/OGRE${OGRE_PATH_SUFFIX}
    /usr/local/lib/x86_64-linux-gnu/ogre${OGRE_PATH_SUFFIX}
    /usr/local/lib/x86_64-linux-gnu/OGRE${OGRE_PATH_SUFFIX}
    $ENV{HOME}/ogre${OGRE_PATH_SUFFIX}
    $ENV{HOME}/OGRE${OGRE_PATH_SUFFIX}
  )
  if (APPLE)
    set(OGRE_PREFIX_GUESSES
...
create_search_paths(OGRE ${OGRE_PATH_SUFFIX})
...
# TODO Levi, figure out why the find_path is not working
set(OGRE_CONFIG_INCLUDE_DIR "/usr/include/OGRE-2.2")
set(OGRE_INCLUDE_DIR "/usr/include/OGRE-2.2")
#find_path(OGRE_CONFIG_INCLUDE_DIR NAMES OgreBuildSettings.h HINTS ${OGRE_INC_SEARCH_PATH} ${OGRE_FRAMEWORK_INCLUDES} ${OGRE_PKGC_INCLUDE_DIRS} PATH_SUFFIXES "OGRE${OGRE_PATH_SUFFIX}")
#find_path(OGRE_INCLUDE_DIR NAMES OgreRoot.h HINTS ${OGRE_CONFIG_INCLUDE_DIR} ${OGRE_INC_SEARCH_PATH} ${OGRE_FRAMEWORK_INCLUDES} ${OGRE_PKGC_INCLUDE_DIRS} PATH_SUFFIXES "OGRE${OGRE_PATH_SUFFIX}")
...
set(OGRE_LIB_SEARCH_PATH "/usr/lib/x86_64-linux-gnu/OGRE-2.2")
find_library(OGRE_LIBRARY_REL NAMES ${OGRE_LIBRARY_NAMES} PATHS ${OGRE_LIB_SEARCH_PATH} ${OGRE_FRAMEWORK_SEARCH_PATH} PATH_SUFFIXES "" "Release" "RelWithDebInfo" "MinSizeRel" NO_DEFAULT_PATH)
find_library(OGRE_LIBRARY_DBG NAMES ${OGRE_LIBRARY_NAMES_DBG} PATHS ${OGRE_LIB_SEARCH_PATH} ${OGRE_FRAMEWORK_SEARCH_PATH} PATH_SUFFIXES "" "Debug" NO_DEFAULT_PATH)
